const problems = [
  ...
  },
  {
    ...
    desc: "Given N (≤ 26) distinct characters, and a word formed from these characters (preserving their order),<br>find the index of the word among all possible ordered subsets (dictionary order).",
    template: [
    ...
    blanks: [
      { line: 1, answers: ["0"], placeholder: "initial value" },
      {
        line: 4,
        answers: [
          "strchr(chars, word[i]) - chars",
          "(strchr(chars, word[i]) - chars)",
          "strchr(chars,word[i])-chars",
        ],
        placeholder: "position of word[i] in chars",
      },
...
function updateProblem() {
  ...
  // Problem statement
  problemDesc.innerHTML = currentProblem.desc;
